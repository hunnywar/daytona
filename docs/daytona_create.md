...
```
  ...
  -i, --ide string                   Specify the IDE (vscode, browser, cursor, ssh, browser-tty, jupyter, fleet, zed, windsurf, clion, goland, intellij, phpstorm, pycharm, rider, rubymine, webstorm)
